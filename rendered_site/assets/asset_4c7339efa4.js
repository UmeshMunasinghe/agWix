...
const SOCIAL_PLAYER_TIKTOK_SDK_TYPE = "$w.TikTokPlayer";
const createSocialPlayerTikTokSdk = (api) => {
  const { props, setProps } = api;
  return {
    get type() {
      return SOCIAL_PLAYER_TIKTOK_SDK_TYPE;
    },
    get src() {
      return props.url || "";
    },
...
const SocialPlayerTikTokSdk = composeSDKFactories([
  elementSdkFactory(SOCIAL_PLAYER_TIKTOK_SDK_TYPE),
  createSocialPlayerTikTokSdk
]);

export { SocialPlayerTikTokSdk as default };
