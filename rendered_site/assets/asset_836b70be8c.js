...
const SOCIAL_PLAYER_SNAPCHAT_SDK_TYPE = "$w.SnapchatPlayer";
const createSocialPlayerSnapchatSdk = (api) => {
  const { props, setProps } = api;
  return {
    get type() {
      return SOCIAL_PLAYER_SNAPCHAT_SDK_TYPE;
    },
    get src() {
      return props.url || "";
    },
...
const SocialPlayerSnapchatSdk = composeSDKFactories([
  elementSdkFactory(SOCIAL_PLAYER_SNAPCHAT_SDK_TYPE),
  createSocialPlayerSnapchatSdk
]);

export { SocialPlayerSnapchatSdk as default };
