...
const SOCIAL_PLAYER_INSTAGRAM_SDK_TYPE = "$w.InstagramPlayer";
const createSocialPlayerInstagramSdk = (api) => {
  const { props, setProps } = api;
  return {
    get type() {
      return SOCIAL_PLAYER_INSTAGRAM_SDK_TYPE;
    },
    get src() {
      return props.url || "";
    },
...
const SocialPlayerInstagramSdk = composeSDKFactories([
  elementSdkFactory(SOCIAL_PLAYER_INSTAGRAM_SDK_TYPE),
  createSocialPlayerInstagramSdk
]);

export { SocialPlayerInstagramSdk as default };
