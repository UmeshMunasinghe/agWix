...
const convertToCorvidKeyboardEvent = (event) => {
...
const registerCorvidKeyboardEvent = (eventName, api, cb, payloadProjection) => registerCorvidEvent(eventName, api, cb, ({ componentEvent, eventPayload }) => ({
...
const keyUpPropsSDKFactory = (api) => {
  return {
...
const clickPropsSDKFactoryWithUpdatePlatformHandler = (api) => {
...
const LegacyContainerSdk = (api) => LegacySdk.factory(api);

export { LegacyContainerSdk as default };
